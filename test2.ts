...
//       symbol: "FULL",
//       name: "hashes",
//       description: "focus not other peoples frame",
//       supply: 69000000,
//       targetStx: 1,
...
//       uri: "", // Backend will generate
//       logoUrl: "https://faktory.fun/drink-milkshake.gif", // Backend will generate
//       mediaUrl: "",
...
// async function testGetVerifiedTokens() {
//   try {
//     console.log("\nFetching verified tokens...");
//     const response = await sdk.getVerifiedTokens({
//       limit: 10,
//       page: 1,
//     });

//     console.log("Found verified tokens:", response.count);
//     response.results.forEach((token) => {
//       console.log(`${token.name} (${token.symbol})`);
//       console.log(`Token: ${token.tokenContract}`);
//       console.log(`DEX: ${token.dexContract}`);
//       console.log("---");
//     });
//   } catch (error) {
